...
terraform {
  ...
  backend "azurerm" {
    resource_group_name  = "RG-SM-AKSCluster"         # mettre ici le nom du resource group de vos ressource
    storage_account_name = "backendterrasm"      # mettre le nom du compte de stockage créer dans le lab 1
